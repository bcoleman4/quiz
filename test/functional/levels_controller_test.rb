...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { description: @level.description, lower_range: @level.lower_range, upper_range: @level.upper_range }
    end
  ...
  test "should update level" do
    put :update, id: @level, level: { description: @level.description, lower_range: @level.lower_range, upper_range: @level.upper_range }
    assert_redirected_to level_path(assigns(:level))
  end
